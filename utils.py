# ────────────────────────────────────────────────────────────
# 📍 Cell 3  — Core Enums and Configuration  (MODIFIED - FIXED)
# ────────────────────────────────────────────────────────────
...
# ------------------------------------------------------------------
# REQUIRED_SLOTS - updated with cuisine_1, cuisine_2, item_name
# ------------------------------------------------------------------
REQUIRED_SLOTS = {
    "dietary": {
        "type": "string",
    ...
    "cuisine_1": {
        "type": "string",
        "values": [],                     # validated with _CUISINES list in Slot-Extraction cell
    ...
    "item_name": {
        "type": "string",
        "values": [],                     # free text – no fixed choices
...
api_key = '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'
